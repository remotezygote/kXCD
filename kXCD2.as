...
package {
	...
	public class kXCD extends Sprite {
		public var baseJSController:String = "window.kXCD";
		public function kXCD() {
			Security.allowDomain('*');
			ExternalInterface.addCallback('get', get);
			ExternalInterface.call(baseJSController+".setAvailability",true);
		}
		public function spit(event:Event):void {
			ExternalInterface.call(baseJSController+".onComplete",event.target.trackid,escape(event.target.data));
		}
